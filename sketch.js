    ...
    if (
     ...
     console.log("PlayerArrow Collided");
      ...
      if (computerArcherLife <=0) {
        ...
        Matter.Body.setStatic(omputerArcher.body, false);
        Matter.Body.setStatic(computer.body, false);
        Matter.Body.setPosition(computer.body, {x: width - 100, y: computer.body.position});
      }
    }
  }
}
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    ...
    if (
      ...
      if (playerArcherLife <=0) {
        ...
        Matter.Body.setPosition(player.body, {x: width - 400, y: player.body.position});
      }
    }
  }
}
